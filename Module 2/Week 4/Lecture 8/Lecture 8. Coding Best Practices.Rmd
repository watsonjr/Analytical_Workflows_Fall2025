...
I tend to write my R code as R Markdown files (like this one) because it's easy to embed my code chunks in longer descriptions. The Integrated Development Environment of RStudio allows for several other features that improve code formatting.
...
I typically use camel case for stored variables and Pascal case for data frame variables because they are the most concise forms (i.e., have fewer characters) and are easy to read.
