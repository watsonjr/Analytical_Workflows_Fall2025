...
When you push commits to GitHub, you must write a message that consists of a required summary (title) and an optional description (more detail). Ideally, you should write commit messages that are easy to understand by others and future you.
...
I tend to write commit messages as present-tense verb clauses, such as:
