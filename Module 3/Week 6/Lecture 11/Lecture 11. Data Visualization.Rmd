...
```{r}
meteorology <- read.csv("Madison Daily Meteorological Data.csv")
biomass <- read.csv("Madison Lakes Area Macrophyte Biomass.csv")
rating <- read.csv("Madison Lakes Area Macrophyte Rating.csv")
```
...
rating$lakeid <- factor(rating$lakeid,
                        levels = c("FI","ME","MO","WI"))
